...
// data-emotion kullanilmis ama import edilmemis ??
...
const EditProfile = () => {
  return (
      ...
      <div className="css-12xng7v">
        <div className="css-by1v3w">
          ...
          <section className="css-1f1bcew">
            <h1 className="css-kgulag">Hesap Ayarları</h1>
            <div className="css-ynrcfa">
              <div className="css-vz13bi">
                ...
                <form>
                  ...
                  <button type="submit" className="css-qlmbjq" disabled>
    ...
    /* 
        <div className="css-1ma0nfe">
            <div className="css-12xng7v">
                <div className="css-by1v3w">
                    <ul className="css-d4spgn">
                        <li className="css-ni308u eugzkiw1">
                            <a name="account" href="/account" className="css-1ljf7si eugzkiw0">Account</a>
                        </li>
                        <li className="css-ni308u eugzkiw1">
                            <a
                                href="https://mubi.com/subscription"
                                name="subscription"
                                className="css-naof45 eugzkiw0">Subscription</a>
                        </li>
                        <li className="css-ni308u eugzkiw1">
                            <a
                                name="e-mail preferences"
                                href="/account/preferences"
                                className="css-naof45 eugzkiw0">E-mail preferences</a>
                        </li>
                        <li className="css-ni308u eugzkiw1">
                            <a name="invite your friends" href="/referrals" className="css-naof45 eugzkiw0">Invite your friends</a>
                        </li>
                        <li className="css-ni308u eugzkiw1">
                            <a name="gift subscription" href="/gifts" className="css-naof45 eugzkiw0">Gift subscription</a>
                        </li>
                        <li className="css-ni308u eugzkiw1">
                            <a
                                name="video playback"
                                href="/account/preferences/video"
                                className="css-naof45 eugzkiw0">Video playback</a>
                        </li>
                        <li className="css-ni308u eugzkiw1">
                            <a name="logout" href="/logout" className="css-naof45 eugzkiw0">Log out</a>
                        </li>
            </ul>
            
                    <section className="css-1f1bcew">
                        <h1 className="css-kgulag">Account</h1>
                        <div className="css-ynrcfa e158zpq70">
                            <div className="css-vz13bi e1jao1d712">
                                <h2 className="css-1sy31cf e1jao1d710">Edit contact details</h2>
                                <form>
                                    <label for="email" className="css-1mknjcb e16aio3l1">Email address<input
                                        type="email"
                                        id="email"
                                        className="css-1gw1u1b e1jao1d74"
                                        value="aebuyuk@hotmail.com"/></label>
                                    <button
                                        type="submit"
                                        className=" e1jao1d73 e1yetvh23 css-qlmbjq e6xeocl0"
                                        disabled="">Update email address</button>
                                </form>
                            </div>
                            <div className="css-vz13bi e1jao1d712">
                                <h2 className="css-1sy31cf e1jao1d710">Change password</h2>
                                <form>
                                    <label for="newPassword" className="css-8gzag4 e1jao1d78">New password<input type="password" id="newPassword" className="css-1gw1u1b e1jao1d74" value=""/></label>
                                    <label for="confirmPassword" className="css-8gzag4 e1jao1d78">Confirm password<input
                                        type="password"
                                        id="confirmPassword"
                                        className="css-1gw1u1b e1jao1d74"
                                        value=""/></label>
                            ...
                            <form>
                                <div className="css-j3we6u ewhtlnr0">
                                    <h2 className="css-1sy31cf e1jao1d710">Edit info</h2>
                                    <label for="name" className="css-8gzag4 e1jao1d78">Name<input type="text" id="name" className="css-1gw1u1b e1jao1d74" value="k'loyi"/></label>
                                </div>


                                <div className="css-1v6s6ue e1jao1d711">
                                    <button type="submit" className=" e1yetvh23 css-k70ug1 e6xeocl0">Update account settings</button>
                                </div>
                                <a href="/account/deactivate" className="css-pkd4kw ewhtlnr1">Need to deactivate your account?</a>
                            </form>
                        </div>
                    </section>
                </div>
    ...
    /*       <div className='edit-profile'>
      ...
      <div className="e14_209"></div><span  className="e14_215">Yeni Şifre </span>
      <div className="e14_211"></div>
    </div>
    <div className='e17_50'><span  className="e14_213">Değiştir</span></div>
  </div>
          </div>
